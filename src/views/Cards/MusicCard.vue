<template>
  <div class="MusicCard">
    <div class="card">
      ...
      <div class="control" @mouseover="ShowButton" @mouseleave="HideButton" >
        <div class="button button-play hide" ><svg t="1679729442836" class="icon" viewBox="0 0 1024 1024" version="1.1"
            xmlns="http://www.w3.org/2000/svg" p-id="2770" width="200" height="200">
            <path
        ...
        <div class="button button-share hide" ><svg t="1679730010240" class="icon" viewBox="0 0 1024 1024" version="1.1"
...
.cover {
  width: 100%;
  height: 100%;
  background-image: url("https://lightmeter30.github.io/img/avatar.jpg");
